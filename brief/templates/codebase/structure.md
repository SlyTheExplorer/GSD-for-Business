...
│   └── gsd/           # BRIEF-specific commands
├── brief/     # Skill resources
...
**New Slash Command:**
- Primary code: `commands/brief/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `brief/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `brief/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/brief/workflows/{name}.md`

**New Reference Document:**
- Implementation: `brief/references/{name}.md`
