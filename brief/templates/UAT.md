...
- This section feeds directly into /brief-plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /brief-plan-phase --gaps with root causes
...
**Creation:** When /brief-verify-work starts new session
...
- `/brief-verify-work {phase}` picks up from first pending/blocked test
