...
- [E001] config.json: JSON parse error at line 5
  Fix: Run /brief-health --repair to reset to defaults

- [E002] PROJECT.md not found
  Fix: Run /brief-new-project to create
```
...
```
---
N issues can be auto-repaired. Run: /brief-health --repair
```
</step>
...
```
Would you like to run /brief-health --repair to fix N issues automatically?
```
