...
Example: `/brief-insert-phase 72 Fix critical auth bug`
-> after = 72
...
Usage: /brief-insert-phase <after> <description>
Example: /brief-insert-phase 72 Fix critical auth bug
```
...
`/brief-plan-phase {decimal_phase}`
...
- Don't use this for planned work at end of milestone (use /brief-add-phase)
- Don't insert before Phase 1 (decimal 0.1 makes no sense)
- Don't renumber existing phases
- Don't modify the target phase content
- Don't create plans yet (that's /brief-plan-phase)
