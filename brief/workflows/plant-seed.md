...
Seeds auto-surface during /brief-new-milestone when trigger conditions match the
...
This seed should be presented during `/brief-new-milestone` when the milestone
...
This seed will surface automatically when you run /brief-new-milestone
