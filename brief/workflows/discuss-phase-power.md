...
<trigger>
This workflow executes when `--power` flag is present in ARGUMENTS to `/brief-discuss-phase`.
...
Consider running /brief-discuss-phase {N} again to refine before planning.
```
