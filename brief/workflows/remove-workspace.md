<purpose>
Remove a BRIEF workspace, cleaning up git worktrees and deleting the workspace directory.
</purpose>
...
First run `/brief-list-workspaces` to show available workspaces, then ask:
