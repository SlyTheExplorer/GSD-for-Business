...
- Example: `/brief-remove-phase 17` → phase = 17
- Example: `/brief-remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /brief-remove-phase <phase-number>
Example: /brief-remove-phase 17
```
...
To abandon current work, use /brief-pause-work instead.
```
...
Would you like to:
- `/brief-progress` — see updated roadmap status
