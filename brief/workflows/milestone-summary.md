...
4. If nothing found: error "No milestone found. Run /brief-new-project or /brief-new-milestone first."
...
If the user is done:
- Suggest next steps: `/brief-new-milestone`, `/brief-progress`, or sharing the summary with the team
