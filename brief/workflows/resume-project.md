...
<required_reading>
@~/.claude/brief/references/continuation-format.md
</required_reading>
...
**If `planning_exists` is false:** This is a new project - route to /brief-new-project
</step>
...
- This is the primary resumption source — structured data from `/brief-pause-work`
...
📋 [N] pending todos — /brief-check-todos to review
...
1. Resume interrupted agent [if interrupted agent found]
   OR
1. Execute phase (/brief-execute-phase {phase} ${GSD_WS})
   OR
1. Discuss Phase 3 context (/brief-discuss-phase 3 ${GSD_WS}) [if CONTEXT.md missing]
   OR
1. Plan Phase 3 (/brief-plan-phase 3 ${GSD_WS}) [if CONTEXT.md exists or discuss option declined]
...
- **Plan phase** → Show command for user to run after clearing:
  ...
  **Also available:**
  - `/brief-discuss-phase [N] ${GSD_WS}` — gather context first
  - `/brief-research-phase [N] ${GSD_WS}` — investigate unknowns
