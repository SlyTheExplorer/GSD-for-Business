...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /brief-research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/brief/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/brief/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/brief/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/brief/templates/discovery.md
...
Use ~/.claude/brief/templates/discovery.md.
...
1. Discuss phase context (/brief-discuss-phase [current-phase])
2. Create phase plan (/brief-plan-phase [current-phase])
