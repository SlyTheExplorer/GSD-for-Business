...
- `/brief-list-phase-assumptions 2` — check assumptions
...
**Also available:**
- `/brief-discuss-phase 2` — gather context first
- `/brief-research-phase 2` — investigate unknowns
- Review roadmap
...
**Also available:**
- `/brief-discuss-phase 3` — gather context first
- `/brief-research-phase 3` — investigate unknowns
...
**To plan directly:** `/brief-plan-phase 3`

**To discuss context first:** `/brief-discuss-phase 3`

**To research unknowns:** `/brief-research-phase 3`
