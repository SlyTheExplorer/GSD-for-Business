...
function isValidConfigKey(keyPath) {
  ...
  // Allow review.models.<cli-name> for per-CLI model selection in /brief-review
 ...
 *   3. userChoices — the settings the user explicitly selected during /brief-new-project
 *
 ...
 * configured during /brief-new-project). All remaining keys are filled from
