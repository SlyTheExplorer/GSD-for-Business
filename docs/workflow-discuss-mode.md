...
BRIEF's discuss-phase has two modes for gathering implementation context before planning.
...
brief-tools config-set workflow.discuss_mode assumptions

# Switch back to interview mode
brief-tools config-set workflow.discuss_mode discuss
```
