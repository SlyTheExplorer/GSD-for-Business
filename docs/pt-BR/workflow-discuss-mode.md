...
O BRIEF oferece dois estilos para `/brief-discuss-phase`:
...
1. BRIEF lê `PROJECT.md`, mapeamento de código e convenções
2. Gera lista estruturada de suposições
3. Você confirma, corrige ou expande
4. BRIEF escreve `CONTEXT.md` com decisões consolidadas
