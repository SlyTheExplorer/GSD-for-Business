#!/usr/bin/env bash
# Release monitor for gsd-build/brief
# Checks every 15 minutes, writes new release info to a signal file

REPO="gsd-build/brief"
SIGNAL_FILE="/tmp/brief-new-release.json"
STATE_FILE="/tmp/brief-monitor-last-tag"
LOG_FILE="/tmp/brief-monitor.log"
