...
/**
 * Extract the tools list from a brief-executor.md agent definition.
...
/**
 * Extract the role instructions from a brief-executor.md agent definition.
 ...
 * @param agentDef - Raw content of brief-executor.md agent definition (optional)
