...
describe('PHASE_AGENT_MAP', () => {
  ...
  it('execute maps to brief-executor.md', () => {
    expect(PHASE_AGENT_MAP[PhaseType.Execute]).toBe('brief-executor.md');
  });

  it('research maps to brief-phase-researcher.md', () => {
    expect(PHASE_AGENT_MAP[PhaseType.Research]).toBe('brief-phase-researcher.md');
  });

  it('plan maps to brief-planner.md', () => {
    expect(PHASE_AGENT_MAP[PhaseType.Plan]).toBe('brief-planner.md');
  });

  it('verify maps to brief-verifier.md', () => {
    expect(PHASE_AGENT_MAP[PhaseType.Verify]).toBe('brief-verifier.md');
  });
