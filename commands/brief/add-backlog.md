...
3. **Add to ROADMAP.md** under a `## Backlog` section. If the section doesn't exist, create it at the end.
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (promote with /brief-review-backlog when ready)
   ```
...
6. **Report:**
   ...
   Use /brief-discuss-phase {NEXT} to explore it further.
   Use /brief-review-backlog to promote items to active milestone.
   ```
...
- Phase directories are created immediately, so /brief-discuss-phase and /brief-plan-phase work on them
