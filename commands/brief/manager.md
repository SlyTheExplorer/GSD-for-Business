...
**Creates/Updates:**
- No files created directly — dispatches to existing BRIEF commands via Skill() and background Task agents.
...
<process>
Execute the manager workflow from @~/.claude/brief/workflows/manager.md end-to-end.
