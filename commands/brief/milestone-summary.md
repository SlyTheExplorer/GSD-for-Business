...
<execution_context>
@~/.claude/brief/workflows/milestone-summary.md
</execution_context>
...
<process>
Read and execute the milestone-summary workflow from @~/.claude/brief/workflows/milestone-summary.md end-to-end.
</process>
