...
// (no active /brief- skill or Task subagent) and injects an advisory warning.
//
// This is a SOFT guard — it advises, not blocks. The edit still proceeds.
// The warning nudges Claude to use /brief-quick or /brief-fast instead of
...
process.stdin.on('end', () => {
  ...
  try {
    ...
    // Check if we're inside a GSD workflow (Task subagent or /brief- skill)
    ...
    const output = {
      hookSpecificOutput: {
        ...
        additionalContext: `⚠️ WORKFLOW ADVISORY: You're editing ${path.basename(filePath)} directly without a GSD command. ` +
          ...
          'Consider using /brief-fast for trivial fixes or /brief-quick for larger changes ' +
