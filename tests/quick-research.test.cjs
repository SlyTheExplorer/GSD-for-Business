 ...
 *
 * Validates the --research flag for /brief-quick:
 ...
 * - Workflow spawns brief-phase-researcher for research
 */
...
describe('quick workflow: research step', () => {
  ...
  test('research step spawns brief-phase-researcher', () => {
    content = fs.readFileSync(workflowPath, 'utf-8');
    ...
    assert.ok(
      researchSection.includes('subagent_type="brief-phase-researcher"'),
      'research step should spawn brief-phase-researcher agent'
    );
  });
