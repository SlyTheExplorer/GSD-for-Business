...
const SH_HOOKS = [
  { name: 'brief-validate-commit.sh', settingsVar: 'validateCommitCommand' },
  { name: 'brief-session-state.sh',   settingsVar: 'sessionStateCommand' },
  { name: 'brief-phase-boundary.sh',  settingsVar: 'phaseBoundaryCommand' },
];
